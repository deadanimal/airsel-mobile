...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MeasurementTypePage", function() { return MeasurementTypePage; });
...
/* harmony import */ var src_app_shared_services_operational_readings_operational_readings_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/services/operational-readings/operational-readings.service */ "./src/app/shared/services/operational-readings/operational-readings.service.ts");
...
let MeasurementTypePage = class MeasurementTypePage {
    constructor(alertController, formBuilder, datePipe, location, menu, modalController, navParams, notificationService, operationalreadingService) {
    ...
    alertMeasurementType(header, message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const alert = yield this.alertController.create({
                header,
                message,
...
MeasurementTypePage.ctorParameters = () => [
...
MeasurementTypePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: "app-measurement-type",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./measurement-type.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/technical/measurement-type/measurement-type.page.html")).default,
        providers: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["DatePipe"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./measurement-type.page.scss */ "./src/app/pages/technical/measurement-type/measurement-type.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"],
        ...
        src_app_shared_services_operational_readings_operational_readings_service__WEBPACK_IMPORTED_MODULE_6__["OperationalReadingsService"]])
], MeasurementTypePage);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationalReadingsService", function() { return OperationalReadingsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let OperationalReadingsService = class OperationalReadingsService {
    constructor(http) {
        this.http = http;
        this.url = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseUrl + "v1/operational-readings-pipe/";
        // Data
        this.ormodels = [];
    }
    post(body) {
...
OperationalReadingsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
];
OperationalReadingsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: "root",
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])
], OperationalReadingsService);
...
//# sourceMappingURL=default~pages-technical-measurement-type-measurement-type-module~pages-technical-operational-reading~b806443f-es2015.js.map