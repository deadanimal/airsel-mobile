...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationalReadingPageRoutingModule", function() { return OperationalReadingPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _operational_reading_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./operational-reading.page */ "./src/app/pages/technical/operational-reading/operational-reading.page.ts");
...
let OperationalReadingPageRoutingModule = class OperationalReadingPageRoutingModule {
};
OperationalReadingPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationalReadingPageModule", function() { return OperationalReadingPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
/* harmony import */ var _operational_reading_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./operational-reading-routing.module */ "./src/app/pages/technical/operational-reading/operational-reading-routing.module.ts");
/* harmony import */ var _operational_reading_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./operational-reading.page */ "./src/app/pages/technical/operational-reading/operational-reading.page.ts");
...
let OperationalReadingPageModule = class OperationalReadingPageModule {
};
OperationalReadingPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _operational_reading_routing_module__WEBPACK_IMPORTED_MODULE_5__["OperationalReadingPageRoutingModule"],
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationalReadingPage", function() { return OperationalReadingPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var src_app_shared_services_asset_registrations_asset_registrations_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/services/asset-registrations/asset-registrations.service */ "./src/app/shared/services/asset-registrations/asset-registrations.service.ts");
/* harmony import */ var src_app_shared_services_notifications_notifications_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/shared/services/notifications/notifications.service */ "./src/app/shared/services/notifications/notifications.service.ts");
/* harmony import */ var src_app_shared_services_operational_readings_operational_readings_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/shared/services/operational-readings/operational-readings.service */ "./src/app/shared/services/operational-readings/operational-readings.service.ts");
/* harmony import */ var _measurement_type_measurement_type_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../measurement-type/measurement-type.page */ "./src/app/pages/technical/measurement-type/measurement-type.page.ts");
/* harmony import */ var src_app_shared_services_assets_assets_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/shared/services/assets/assets.service */ "./src/app/shared/services/assets/assets.service.ts");
/* harmony import */ var src_app_shared_services_owning_organisations_owning_organisations_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/shared/services/owning-organisations/owning-organisations.service */ "./src/app/shared/services/owning-organisations/owning-organisations.service.ts");
...
/* harmony import */ var src_app_shared_services_auth_auth_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/shared/services/auth/auth.service */ "./src/app/shared/services/auth/auth.service.ts");
...
let OperationalReadingPage = class OperationalReadingPage {
    constructor(alertController, formBuilder, datePipe, location, menu, modalController, assetregistrationService, notificationService, operationalreadingService, route, router, 
    ...
    camera, assetsService, owningorganisationsService, assetLocatioSyncService, authService) {
        ...
        this.operationalreadingFormGroup = this.formBuilder.group({
            ...
            location: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]({ value: "", disabled: true }),
            asset_description: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]({ value: "", disabled: true }),
            record_by: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.authService.userID),
            modified_by: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](this.authService.userID)
        ...
        this.route.queryParams.subscribe((params) => {
            if (this.router.getCurrentNavigation().extras.state) {
                ...
                this.operationalreadingFormGroup.patchValue(Object.assign({}, this.router.getCurrentNavigation().extras.state.operationalreading));
    ...
    getAssetLocationSync(node_id) {
        ...
        this.assetLocatioSyncService.filter("node_id=" + node_id).subscribe((res) => {
    ...
    emptyMeasuremntType(header, message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const alert = yield this.alertController.create({
                header,
                message,
    ...
    submit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.operationalreadingService
                ...
                .subscribe((res) => {
                console.log("res", res);
                this.alertOperationalReading("Operational Reading", 
    ...
    alertOperationalReading(header, message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const alert = yield this.alertController.create({
                header,
                message,
    ...
    clickAddMeasurementType() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            modal.onDidDismiss().then((value) => {
                this.operationalreadingFormGroup.patchValue(Object.assign({}, value.data, { reading_date_time: new Date(value.data.reading_date).toISOString() }));
            });
...
OperationalReadingPage.ctorParameters = () => [
...
OperationalReadingPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: "app-operational-reading",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./operational-reading.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/technical/operational-reading/operational-reading.page.html")).default,
        providers: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["DatePipe"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./operational-reading.page.scss */ "./src/app/pages/technical/operational-reading/operational-reading.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_5__["AlertController"],
        ...
        src_app_shared_services_asset_registrations_asset_registrations_service__WEBPACK_IMPORTED_MODULE_7__["AssetRegistrationsService"],
        src_app_shared_services_notifications_notifications_service__WEBPACK_IMPORTED_MODULE_8__["NotificationsService"],
        src_app_shared_services_operational_readings_operational_readings_service__WEBPACK_IMPORTED_MODULE_9__["OperationalReadingsService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"],
        _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
        _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_6__["Camera"],
        src_app_shared_services_assets_assets_service__WEBPACK_IMPORTED_MODULE_11__["AssetsService"],
        src_app_shared_services_owning_organisations_owning_organisations_service__WEBPACK_IMPORTED_MODULE_12__["OwningorganisationsService"],
        ...
        src_app_shared_services_auth_auth_service__WEBPACK_IMPORTED_MODULE_14__["AuthService"]])
], OperationalReadingPage);
...
//# sourceMappingURL=default~pages-technical-operational-reading-operational-reading-module~pages-technical-technical-module-es2015.js.map