...
/* harmony import */ var src_app_shared_services_employee_employee_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/services/employee/employee.service */ "./src/app/shared/services/employee/employee.service.ts");
/* harmony import */ var src_app_shared_handler_notification_notification_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/handler/notification/notification.service */ "./src/app/shared/handler/notification/notification.service.ts");
...
/* harmony import */ var src_app_shared_services_wams_wams_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/shared/services/wams/wams.service */ "./src/app/shared/services/wams/wams.service.ts");
...
let LoginPage = class LoginPage {
    constructor(alertController, menu, router, authService, employeeService, userService, wamsService, formBuilder, toastr) {
    ...
    login() {
        ...
        this.wamsService.getService(bodyAD).subscribe((resAD) => {
            console.log("sini 1");
            ...
            if (resAD.status == "valid") {
                ...
                this.employeeService
                    ...
                    if (resEmp.length > 0) {
                        ...
                        this.userService.filter('employee_id=' + resEmp[0].uuid).subscribe((resUserSer) => {
                            ...
                            if (resUserSer.length == 0) {
                                ...
                                this.authService.registerAccount(bodyPIPE).subscribe((resPIPE) => {
...
LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"],
        ...
        src_app_shared_services_employee_employee_service__WEBPACK_IMPORTED_MODULE_6__["EmployeeService"],
        src_app_shared_services_users_users_service__WEBPACK_IMPORTED_MODULE_8__["UsersService"],
        src_app_shared_services_wams_wams_service__WEBPACK_IMPORTED_MODULE_9__["WamsService"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"],
        src_app_shared_handler_notification_notification_service__WEBPACK_IMPORTED_MODULE_7__["NotificationService"]])
], LoginPage);
